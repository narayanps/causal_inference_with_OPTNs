...
for i=4:1:N+N_ignore
    ...
    x_2(i) = 3.4 * x_2(i-1) * (1 - x_2(i-1)*x_2(i-1))*exp(-(x_2(i-1).^2)) + c12*x_1(i-1).^2 + c32*x_3(i-3).^1 + randn;
    x_3(i) = 3.4 * x_3(i-1) * (1 - x_3(i-1)*x_3(i-1))*exp(-(x_3(i-1).^2)) + c23*x_2(i-2).^1   + randn;
